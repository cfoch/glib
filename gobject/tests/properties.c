...
properties_testv_with_no_properties (void)
{
  ...
  test_obj = g_object_new_with_properties (test_object_get_type (), 0,
      NULL, NULL);
...
properties_testv_with_valid_properties (void)
{
  ...
  /* Test newv_with_properties && getv */
  test_obj = g_object_new_with_properties (test_object_get_type (), 4,
      prop_names, values_in);
  g_object_getv (G_OBJECT (test_obj), 4, prop_names, values_out);
  ...
  if (g_test_subprocess ())
    {
      ...
      test_obj = g_object_new_with_properties (test_object_get_type (), 4,
          invalid_prop_names, values_in);
      /* This call should give 3 Critical errors. Actually, a critical error
...
properties_testv_notify_queue (void)
{
  ...
  /* Test newv_with_properties && getv */
  test_obj = g_object_new_with_properties (test_object_get_type (), 0, NULL,
      NULL);
